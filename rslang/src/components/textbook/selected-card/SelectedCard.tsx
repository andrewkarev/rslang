...
const SelectedCard: React.FC<Props> = ({
  ...
  const ROOT_URL = "https://rslang-project-2022.adaptable.app/";
  ...
  const updateDatabaseData = async (userId: string, word: IUserWord) => {
    if (!userWord) {
      await learnWordAPI.createUserWord(userId, currentWord.id, word);
    } else {
      await learnWordAPI.updateUserWord(userId, currentWord.id, word);
    }
  ...
  return (
    <div className={styles["selected-card"]}>
      <img
        className={styles["selected-card-image"]}
      ...
      <div className={styles["word-wrapper"]}>
        ...
        <div className={styles["meaning"]}>
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: currentWord ? currentWord.textMeaning : "",
            }}
          ></p>
        ...
        <div className={styles["example"]}>
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: currentWord ? currentWord.textExample : "",
            }}
          ></p>
